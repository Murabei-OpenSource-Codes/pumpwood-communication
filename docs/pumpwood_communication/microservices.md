# Module pumpwood_communication.microservices
...
def flatten_parallel(
    parallel_result: <function PumpWoodMicroService.list at 0x76baf97fb940>
)
```
...
|---|---|---|---|
| parallel_result | list | A list of lists to be flated (concatenate<br>all lists into one). | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| response [requests.models.Response] | None | Request reponse to check for<br>invalid token. | None |
...
def bulk_save(
    self,
    model_class: str,
    data_to_save: <function PumpWoodMicroService.list at 0x76baf97fb940>,
    auth_header: dict = None
)
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| model_class | str | Data model class. | None |
| data_to_save | list | A list of objects to be saved. | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| auth_header | dict | AuthHeader to substitute the<br>microservice original | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| mfa_login_data [dict] | None | Result from login request with 'mfa_token'<br>as key. | None |
...
|---|---|
| Exception | If content-type is not application/json. |
| Exception | If content-type is application/json, but type not<br>present or not recognisable. |
| Other Exception | If content-type is application/json if type is<br>present and recognisable. |
...
def execute_action(
    ...
    pk: int = None,
    parameters: dict = {},
    files: <function PumpWoodMicroService.list at 0x76baf97fb940> = None,
    auth_header: dict = None
)
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| model_class | str | Model class to run action the object | None |
| action | str | Action that will be performed. | None |

**Returns:**

| Type | Description |
|---|---|
| None | pk (int): Pk of the object that action will be performed over.<br>parameters (dict): Parameter dictionary to use in the action. |

**Raises:**

| Type | Description |
|---|---|
| dict | Return a dict with four keys:<br>- result: Result of the action.<br>- action: Action description.<br>- parameters: Parameters used to perform action.<br>- obj: Object over which were performed the action. |
...
```python3
def flat_list_by_chunks(
    self,
    model_class: str,
    filter_dict: dict = {},
    exclude_dict: dict = {},
    fields: <function PumpWoodMicroService.list at 0x76baf97fb940> = None,
    show_deleted: bool = False,
    auth_header: dict = None,
    chunk_size: int = 1000000,
    n_parallel: int = None,
...
#### get_pks_from_unique_field

```python3
def get_pks_from_unique_field(
    self,
    model_class: str,
    field: str,
    values: List[Any]
...
| Name | Type | Description | Default |
|---|---|---|---|
| model_class [str] | None | Model class of the objects. | None |
| field [str] | None | Unique field to fetch pk. | None |
| values [List[Any]] | None | List of the unique fields used to fetch<br>primary keys. | None |
...
#### is_microservice_registered

```python3
def is_microservice_registered(
    self,
    microservice: str,
    auth_header: dict = None
) -> bool
...
| Name | Type | Description | Default |
|---|---|---|---|
| microservice [str] | None | Service associated with microservice<br>registered on Pumpwood Kong. | None |
...
def list_by_chunks(
    ...
    **kwargs
) -> <function PumpWoodMicroService.list at 0x76baf97fb940>
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| Args |  | model_class: str<br>  Model class of the end-point.<br>key: str<br>  Key to list the avaiable values using the query filter and exclude. | None |
| Kwargs |  | filter_dict: dict = {}<br>  Filter dict to be used at the query (objects.filter arguments).<br>exclude_dict: dict = {}<br>  Exclude dict to be used at the query (objects.exclude arguments).<br>auth_header: dict= {}<br>  Dictionary containing the auth header. | None |

**Returns:**

| Type | Description |
|---|---|
| list | List of keys avaiable in results from the query dict. |
...
| Name | Type | Description | Default |
|---|---|---|---|
| Args |  | model_class: str<br>  model_class (str): Model class of the end-point | None |
| Kwargs |  | filter_dict: dict = {}<br>  Filter dict to be used at the query (objects.filter arguments).<br>exclude_dict: dict = {}<br>  Exclude dict to be used at the query (objects.exclude arguments).<br>auth_header: dict= {}<br>  Dictionary containing the auth header. | None |
...
def list_without_pag(
    ...
    filter_dict: dict = {},
    exclude_dict: dict = {},
    order_by: <function PumpWoodMicroService.list at 0x76baf97fb940> = [],
    auth_header: dict = None,
...
```python3
def paralell_request_delete(
    self,
    urls_list: <function PumpWoodMicroService.list at 0x76baf97fb940>,
    n_parallel: int = None,
    auth_header: dict = None
)
```
...
```python3
def paralell_request_post(
    self,
    urls_list: <function PumpWoodMicroService.list at 0x76baf97fb940>,
    data_list: <function PumpWoodMicroService.list at 0x76baf97fb940>,
    n_parallel: int = None,
    auth_header: dict = None
)
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| model_class | None | Model class of the data that will be saved. | None |
| data_to_save | list or pandas.DataFrame | Data that will be saved | None |
...
def parallel_pivot(
    ...
    format: str,
    n_parallel: int = None,
    variables: <function PumpWoodMicroService.list at 0x76baf97fb940> = None,
    show_deleted=False,
    auth_header: dict = None
)
```
...
#### parallel_retrieve_file

```python3
def parallel_retrieve_file(
    self,
    model_class: str,
    list_pk: List[int],
    file_field: str = None,
...
def pivot(
    self,
    model_class: str,
    columns: <function PumpWoodMicroService.list at 0x76baf97fb940> = [],
    format: str = 'list',
    filter_dict: dict = {},
    exclude_dict: dict = {},
    order_by: <function PumpWoodMicroService.list at 0x76baf97fb940> = [],
...
| Name | Type | Description | Default |
|---|---|---|---|
| obj_dict | dict | Model data dictionary. It must have 'model_class'<br>key and if 'pk' key is not defined a new object will<br>be created, else object with pk will be updated. | None |
...
|---|---|
| PumpWoodObjectSavingException(
      'To save an object obj_dict must have model_class defined.') | Will be raised if model_class key is not present on<br>obj_dict dictionary |
...
| Name | Type | Description | Default |
|---|---|---|---|
| model_class | str | Model class of the object. | None |
| pk | int | pk of the object. | None |
| file_field | str | File field that will receive file stream. | None |
| file | io.BufferedReader | File to upload. | None |
...
def set_auth_header(
    self,
    auth_header: dict,
    token_expiry: pandas._libs.tslibs.timestamps.Timestamp
) -> None
```
...
| Name | Type | Description | Default |
|---|---|---|---|
| auth_header [dict] | None | Authentication header to be set. | None |
| token_expiry [pd.Timestamp] | None | Token expiry datetime to be set. | None |
